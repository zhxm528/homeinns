...
const hotelOptions = [
  { label: '北京建国饭店', value: '001' },
  { label: '上海建国饭店', value: '002' },
  { label: '广州建国饭店', value: '003' },
];

const HotelRatecodeReport: React.FC = () => {
  ...
  const getQueryConditionsText = () => {
    ...
    if (selectedHotel) {
      const hotel = hotelOptions.find(h => h.value === selectedHotel);
      conditions.push(`酒店: ${hotel?.label || selectedHotel}`);
    }
...
export default HotelRatecodeReport;
