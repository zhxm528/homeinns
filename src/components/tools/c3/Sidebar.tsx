...
import { menuData, MenuItem } from './menu';

export default function C3Sidebar() {
  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-200 h-full overflow-y-auto flex-shrink-0">
      <div className="p-4">
        <div className="mb-4">
          <Link href="/tools/c3" className="text-lg font-semibold text-gray-900 hover:text-blue-600">
            C3 菜单
          </Link>
        </div>
