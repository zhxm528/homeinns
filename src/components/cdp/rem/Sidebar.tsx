...
const menuData: MenuItem[] = [
  ...
  {
    name: "推荐位管理",
    href: "/cdp/rem/position-management",
  },
  {
    name: "推荐效果",
    href: "/cdp/rem/effect",
...
export default function REMSidebar() {
  ...
  return (
    <aside className="w-64 bg-white border-r border-gray-200 h-full overflow-y-auto flex-shrink-0">
      <div className="p-4">
        <div className="mb-4">
          <Link href="/cdp/rem" className="text-lg font-semibold text-gray-900 hover:text-blue-600">
            智能推荐
          </Link>
        </div>
