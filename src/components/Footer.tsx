        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold">HomeInns</span>
            </div>
            <p className="text-gray-400 text-sm mb-4">
              专业的AI Agent平台，为个人和企业提供智能对话和工具调用服务。
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6 mt-4 md:mt-0">
              <span className="text-gray-400 text-sm">Made with ❤️ in China</span>
              <div className="flex items-center space-x-2">
                <span className="text-gray-400 text-sm">语言:</span>
                <button className="text-white hover:text-gray-300 text-sm">中文</button>
