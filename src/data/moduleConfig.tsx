...
export const moduleDescriptions: Record<string, ModuleDescription> = {
  ...
  promotion40: {
    id: "promotion40",
    descriptionEn: "Promotion 4.0",
    descriptionCn: "统一促销管理入口",
  },
};

export const getModuleDescription = (id: string): ModuleDescription | undefined => {
  return moduleDescriptions[id];
};
