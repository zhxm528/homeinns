...
export const privateDomainMetricDetails: Record<string, PrivateDomainMetricDetail> = {
  ...
  "metric-two": {
    id: "metric-two",
    name: "指标二：逸粉每百人成功拉新",
    definition: "衡量门店通过企微等方式，将可转化住客成功注册为逸粉会员的能力。",
    formula: "（成功拉新逸粉人数 ÷ 可拉新逸粉总人数）× 100",
    numerator: "考核有效期内完成逸粉注册的入住客人",
    denominator: "门店所有入住客人（剔除非身份证入住、已是逸粉会员的客人）",
    exclusions: ["非身份证入住客人", "已是逸粉会员的客人"],
    period: "入住期间或离店当天",
    target: "28",
    currentValue: "26.2",
    yoy: "-0.6%",
  ...
  "metric-three": {
    ...
    definition: "衡量门店将预订行为从 OTA/协议渠道迁移至逸扉小程序的能力。",
    formula: "（P3 小程序渠道预订间夜数 ÷ P3 全渠道预订间夜数）× 100%",
    numerator: "P3 小程序渠道预订间夜数",
    denominator: "P3 全渠道预订间夜数（剔除退款、取消订单、非身份证预订）",
    exclusions: ["退款订单", "取消订单", "非身份证预订"],
    period: "Q1（P3 口径）",
    target: "17%",
    currentValue: "15.8%",
    yoy: "+0.9%",
  ...
  "metric-four": {
    ...
    definition: "衡量高等级会员（≥金牛）是否形成稳定的本人小程序预订与实际入住行为。",
    formula: "（P3 金牛及以上本人预订并入住人数 ÷ P3 全渠道预订人数）× 100",
    numerator: "金牛/黑金/钻石逸粉本人预订并实际入住人数",
    denominator: "P3 全渠道预订人数（剔除非身份证预订）",
    exclusions: ["非身份证预订", "非本人账号预订"],
    period: "Q1（仅限逸扉小程序渠道）",
    target: "10%",
    currentValue: "9.1%",
    yoy: "+0.6%",
